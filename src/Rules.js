...
const fullHouse = new FullHouse({ score: 25, description: "25 points for a full houce" });

// small/large straights score as 30/40
const smallStraight = new SmallStraight({ score: 30, description: "30 points for a small straight" });
const largeStraight = new LargeStraight({ score: 40, description: "25 points for a large straight" });

// yahtzee scores as 50
const yahtzee = new Yahtzee({ score: 50, description: "25 points for yahtzee" });
